...
describe("in_list", function () {
  ...
  it("white, mail", function () {
    ...
    assert.equal(
      true,
      this.plugin.in_list("white", "mail", "matt@example.com"),
    );
  ...
  it("white, rcpt", function () {
    ...
    assert.equal(
      true,
      this.plugin.in_list("white", "rcpt", "matt@example.com"),
    );
  ...
  it("white, helo", function () {
    ...
    assert.equal(
      true,
      this.plugin.in_list("white", "helo", "matt@example.com"),
    );
  ...
  it("black, mail", function () {
    ...
    assert.equal(
      true,
      this.plugin.in_list("black", "mail", "matt@example.com"),
    );
  ...
  it("black, rcpt", function () {
    ...
    assert.equal(
      true,
      this.plugin.in_list("black", "rcpt", "matt@example.com"),
    );
  ...
  it("black, helo", function () {
    ...
    assert.equal(
      true,
      this.plugin.in_list("black", "helo", "matt@example.com"),
    );
...
describe("in_re_list", function () {
  ...
  it("white, mail", function () {
    ...
    assert.equal(
      true,
      this.plugin.in_re_list("white", "mail", "matt@exam.ple"),
    );
    assert.equal(
      true,
  ...
  it("white, rcpt", function () {
    ...
    assert.equal(
      true,
      this.plugin.in_re_list("white", "rcpt", "matt@exam.ple"),
    );
    assert.equal(
      true,
  ...
  it("white, helo", function () {
    ...
    assert.equal(
      true,
      this.plugin.in_re_list("white", "helo", "matt@exam.ple"),
    );
    assert.equal(
      true,
  ...
  it("black, mail", function () {
    ...
    assert.equal(
      true,
      this.plugin.in_re_list("black", "mail", "matt@exam.ple"),
    );
    assert.equal(
      true,
  ...
  it("black, rcpt", function () {
    ...
    assert.equal(
      true,
      this.plugin.in_re_list("black", "rcpt", "matt@exam.ple"),
    );
    assert.equal(
      true,
  ...
  it("black, helo", function () {
    ...
    assert.equal(
      true,
      this.plugin.in_re_list("black", "helo", "matt@exam.ple"),
    );
    assert.equal(
      true,
